...
class GithubService:
    ...
    def get_commit_activity(self, repo):
        ...
        return {
            ...
            'commits_per_month': { k.strftime('%Y-%m'): v for k, v in sorted(commits_per_month.items()) },
            ...
            'commits_per_week': { k.strftime('%d/%m/%y'): v for k, v in sorted(commits_per_week.items()) },
        }
